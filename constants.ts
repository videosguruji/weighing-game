...
// Base64 encoded audio files - Cleaned whitespace
...
const CLICK_SOUND_BASE64 = 'data:audio/wav;base64,UklGRiQAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YQAAAAAA////AP8A'; // Short blip

// Helper to create audio safely (prevents SSR/Build errors if Audio is not defined)
const createAudio = (src: string, volume: number = 1.0) => {
